...
public class ScanSceneManager : MonoBehaviour
{
    ...
    void Start()
    {
        try
        {
            ...
            bluetoothHelper = BluetoothHelper.GetInstance("Nano");
            bluetoothHelper.OnConnected += OnConnected;
            bluetoothHelper.OnConnectionFailed += OnConnectionFailed;
            bluetoothHelper.OnDataReceived += OnMessageReceived; //read the data
            bluetoothHelper.OnScanEnded += OnScanEnded;

            BluetoothHelperCharacteristic characteristic = new BluetoothHelperCharacteristic("2A57"); //beb5483e-36e1-4688-b7f5-ea07361b26a8
            characteristic.setService("180A"); //4fafc201-1fb5-459e-8fcc-c5c9c331914b
            ...
            if (!bluetoothHelper.ScanNearbyDevices())
            {
                ...
                bluetoothHelper.setDeviceName("Nano 33 IoT");
    ...
    void OnScanEnded(LinkedList<BluetoothDevice> nearbyDevices)
    {
        ...
        {
            if(device.DeviceName == "Nano 33 IoT")
                Debug.Log("FOUND!!");
        }
